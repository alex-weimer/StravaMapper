...
var init_cookie = __esm({
  "node_modules/.pnpm/@auth+core@0.28.2/node_modules/@auth/core/lib/utils/cookie.js"() {
    __classPrivateFieldSet = /* @__PURE__ */ __name(function(receiver, state2, value, kind, f3) {
      if (kind === "m")
    ...
    __classPrivateFieldGet = /* @__PURE__ */ __name(function(receiver, state2, kind, f3) {
      if (kind === "a" && !f3)
...
var init_timing_safe_equal = __esm({
  "node_modules/.pnpm/jose@5.10.0/node_modules/jose/dist/browser/runtime/timing_safe_equal.js"() {
    timingSafeEqual = /* @__PURE__ */ __name((a3, b3) => {
...
function randomString(size) {
  ...
  const r4 = /* @__PURE__ */ __name((a3, i3) => a3 + i2hex(i3), "r4");
...
var init_preact_module = __esm({
  "node_modules/.pnpm/preact@10.11.3/node_modules/preact/dist/preact.module.js"() {
    ...
    n = e.slice, l = { __e: /* @__PURE__ */ __name(function(n4, l3, u3, i3) {
      ...
      throw n4;
    }, "__e") }, u = 0, i = /* @__PURE__ */ __name(function(n4) {
...
var init_dist = __esm({
  "node_modules/.pnpm/preact-render-to-string@5.2.3_preact@10.11.3/node_modules/preact-render-to-string/dist/index.mjs"() {
    ...
    i2 = /^xlink:?./;
    a2 = /["&<]/;
    s2 = /* @__PURE__ */ __name(function(e3, t3) {
      return String(e3).replace(/(\n+)/g, "$1" + (t3 || "	"));
    }, "s2");
    f2 = /* @__PURE__ */ __name(function(e3, t3, r4) {
    ...
    m2 = { shallow: true };
    k2.render = k2;
    b2 = /* @__PURE__ */ __name(function(e3, t3) {
      return k2(e3, t3, m2);
    }, "b2");
    x = [];
    C2 = Array.isArray;
...
function sequence(...handlers) {
  ...
  return ({ event, resolve: resolve2 }) => {
    ...
    function apply_handle(i3, event2, parent_options) {
      ...
      return handle2({
        event: event2,
        resolve: /* @__PURE__ */ __name((event3, options2) => {
...
var init_hooks_server = __esm({
  ".svelte-kit/output/server/chunks/hooks.server.js"() {
    ...
    securityHeaders = /* @__PURE__ */ __name(async ({ event, resolve: resolve2 }) => {
...
function withoutTransition(action) {
  ...
  const disable = /* @__PURE__ */ __name(() => document.head.appendChild(style), "disable");
  const enable = /* @__PURE__ */ __name(() => document.head.removeChild(style), "enable");
...
function createUserPrefersMode() {
  ...
  const { subscribe: subscribe2, set: _set } = writable(value, () => {
    if (!isBrowser)
      return;
    const handler = /* @__PURE__ */ __name((e3) => {
...
var init_Loading = __esm({
  ".svelte-kit/output/server/chunks/Loading.js"() {
    ...
    noopStorage = {
      ...
      getItem: /* @__PURE__ */ __name((_key) => null, "getItem"),
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      setItem: /* @__PURE__ */ __name((_key, _value) => {
      }, "setItem")
    };
    ...
    range = /* @__PURE__ */ __name((size, startAt = 0) => [...Array(size).keys()].map((i3) => i3 + startAt), "range");
    css = {
...
function get_cookies(request, url, trailing_slash) {
  ...
  const initial_cookies = parse_12(header, { decode: /* @__PURE__ */ __name((value) => value, "decode") });
  ...
  function get_cookie_header(destination, header2) {
    ...
    if (header2) {
      const parsed = parse_12(header2, { decode: /* @__PURE__ */ __name((value) => value, "decode") });
...
async function respond(request, options2, manifest2, state2) {
  ...
  try {
    ...
    const response = await options2.hooks.handle({
      event,
      resolve: /* @__PURE__ */ __name((event2, opts) => resolve2(event2, opts).then((response2) => {
...
// ../../.wrangler/tmp/bundle-bhtPrq/middleware-insertion-facade.js
...
// ../../.wrangler/tmp/bundle-bhtPrq/middleware-loader.entry.ts
...
cookie/index.js:
   ...
   *)
*/
//# sourceMappingURL=bundledWorker-0.9136366043776998.mjs.map
